...
The Deal-
---------
When all the player has placed his/her bet, the dealer gives one card face up, and then one card face up to themselves. Another round of cards is then dealt face up, but the dealer takes the second card face down. Thus, the player except the dealer receives two cards face up, and the dealer receives one card face up and one card face down. 
...
--------------------
When a player's turn comes, they can say "Hit" or "stand" by typing it into the input box.
